...
class TestAddReviewApi:
    def test_POST_add_review_status_201(self, admin_client, device_review):
        ...
        data = {
        "review_title": f"device_review.review_title 123",
        ...
        assert models.DeviceReview.objects.filter(review_title=data.get("review_title")).exists()
    ...
    def test_POST_add_review_status_401(self, device_review):
        ...
        assert not models.DeviceReview.objects.filter(review_title=data.get("review_title")).exists()
